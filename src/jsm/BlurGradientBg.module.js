...
function M (t, e, i) {
  var r = e[0],
    ...
    o = i[2]
  return (
    (t[0] = n * o - s * h), (t[1] = s * a - r * o), (t[2] = r * h - n * a), t
  )
}
var k,
  A,
          ...
          value: function (t) {
            ...
            if (
              ...
              for (
                ...
                ;-1 !== c &&
                  ((h[c] = l.name), this.attributeLocations.set(l, c))
              }
          ...
          value: function () {
            ...
            this.gl.renderer.state.currentProgram === this.id ||
              ...
              this.uniformLocations.forEach(function (e, i) {
                ...
                if (s.value.texture)
                  return (r += 1), s.value.update(r), U(t.gl, i.type, e, r)
  ...
  Y = (function (t) {
    function r () {
      var t,
        ...
        h = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1
      i(this, r),
...
var it = (function (t) {
  function r () {
    var t,
      ...
      s = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
      a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
      h = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
      ...
      g = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : 0,
      v = arguments.length > 10 && void 0 !== arguments[10] ? arguments[10] : 1,
      ...
      _ = arguments.length > 14 && void 0 !== arguments[14] ? arguments[14] : 0,
      b = arguments.length > 15 && void 0 !== arguments[15] ? arguments[15] : 1
    return (
      i(this, r),
      u((t = e(this, r, [n, s, a, h, o, l, c, f, d, g, v, p, m, y, _, b])), t)
    )
  }
  return (
    h(r, v(Array)),
    n(r, [
      ...
      {
        key: 'set',
        value: function (t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v) {
          return t.length
            ? this.copy(t)
            : ((function (t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v, p) {
                ;(t[0] = e),
                  (t[1] = i),
                  (t[2] = r),
                  (t[3] = n),
                  ...
                  (t[14] = v),
                  (t[15] = p)
              })(this, t, e, i, r, n, s, a, h, o, u, l, c, f, d, g, v),
              this)
        }
      },
      {
          ...
          return (
            (function (t, e, i) {
              var r,
                ...
                m = i[2]
              e === t
                ? ((t[12] = e[0] * v + e[4] * p + e[8] * m + e[12]),
                  (t[13] = e[1] * v + e[5] * p + e[9] * m + e[13]),
                  (t[14] = e[2] * v + e[6] * p + e[10] * m + e[14]),
                  (t[15] = e[3] * v + e[7] * p + e[11] * m + e[15]))
                : ((r = e[0]),
                  (n = e[1]),
                  (s = e[2]),
                  (a = e[3]),
  ...
  nt = (function (t) {
    function r () {
      var t,
        ...
        a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : n,
        h =
          arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 'YXZ'
      i(this, r),
      ...
      n(r, [
        {
          ...
          value: function () {
            ...
            return (
              Object.assign(this, { near: i, far: n, fov: a, aspect: o }),
...
var ct = (function (t) {
    function r () {
      ...
      return i(this, r), u((t = e(this, r, [n, s, a, h, o, l, c, f, d])), t)
    }
    return (
      h(r, v(Array)),
      n(r, [
            ...
            if (
              ...
              if (
                ...
                this.generateMipmaps &&
                  ...
                  (vt(this.image.width) && vt(this.image.height))
        ...
        for (var B = [], N = 0; N < c; N++)
          this.textures.push(
            ...
            this.gl.framebufferTexture2D(
              this.target,
              this.gl.COLOR_ATTACHMENT0 + N,
              this.gl.TEXTURE_2D,
              this.textures[N].texture,
              0
            ),
            B.push(this.gl.COLOR_ATTACHMENT0 + N)
...
var Pt = (function () {
  ...
  Ot = (function (t) {
    function r () {
      ...
      return (
        i(this, r),
        ((t = e(this, r, [n, 4])).name = 'blur-gradient'),
        t.start(),
        t
      )
    }
    return (
      ...
      n(r, [
            ...
            ;(this.rtt = new yt(this.gl, { width: 512, height: 512 })),
              ...
              (this.rttProgram = new D(this.gl, {
                ...
                uniforms: {
                  ...
                  u_color_0: { value: new Mt(this.palette[0]) },
                  u_color_1: { value: new Mt(this.palette[1]) },
                  u_color_2: { value: new Mt(this.palette[2]) },
                  u_color_3: { value: new Mt(this.palette[3]) },
                  u_scale: { value: 1.3 },
                  u_rand_1: { value: 0 },
                  u_rand_2: { value: 0 }
                }
        ...
        },
        {
          key: '_resetSeed',
          value: function () {
            ;(this.rttProgram.uniforms.u_rand_1.value = 200 * this.rng() - 100),
              (this.rttProgram.uniforms.u_rand_2.value = 200 * this.rng() - 100)
          }
        },
        {
          key: '_makeMaterial',
          value: function () {
            this._planeShader = new D(this.gl, {
              vertex:
                '\n                attribute vec3 position;\n                attribute vec2 uv;\n                uniform mat4 modelViewMatrix;\n                uniform mat4 projectionMatrix;\n                varying vec2 vUv;\n                void main() {\n                    vUv = uv;\n                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);\n                }\n            ',
              fragment:
        ...
        },
        {
          key: '_resetColors',
          value: function () {
            ;(this.rttProgram.uniforms.u_color_0.value = new Mt(
              this.palette[0]
            )),
              (this.rttProgram.uniforms.u_color_1.value = new Mt(
                this.palette[1]
              )),
              (this.rttProgram.uniforms.u_color_2.value = new Mt(
                this.palette[2]
              )),
              (this.rttProgram.uniforms.u_color_3.value = new Mt(
                this.palette[3]
              ))
          }
        },
        {
          key: '_animate',
          value: function () {
            this.rttProgram.uniforms.u_time.value =
              10 * Math.sin(this.frame / 1000)
          }
        },
        {
          key: 'update',
